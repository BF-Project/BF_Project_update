...
<body>
	...
	<div class="preloader_hide">
			...
			<div class="container">
				<form name="form2" method="post" action="qnaUpdateForm" id="update" enctype="multipart/form-data">
		...
		<!--사진수정  -->
				<div class="form-group">
				<input type="hidden" class="form-control" name="nofile" value="${qnaVO.qna_pict_afat}">
				<c:if test="${!empty qnaVO.qna_pict_afat}">
				<img src="<%=request.getContextPath() %>/upload/${qnaVO.qna_pict_afat}" width="200px" id="hideimg"> 
				</c:if>
		 		</div> 
		 ...
		 <button type="button" class="btn btn-success" onclick="location.href='qnaList'"
			     style="padding:8px; background-color: gray; border: 1px solid gray; 
				 border-radius: 6px; color:white;">
