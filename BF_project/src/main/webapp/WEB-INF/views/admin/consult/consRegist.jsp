		...
		<div id="page-wrapper" style="text-align: center; height: 986px;">
			<div class="row">
				...
				<form style="margin-left:-220px" method="post" action='ConsManager'>
					이름 : <br><input type="text" class="form-control" id="irum" name="irum" style="width:200px; margin-left:1045px;"/><br>
					이메일 : <br><input type="text" class="form-control" id="email" name="email" style="width:400px; margin-left:1045px;" /><br>
