...
//xml에 쿼리 기입추가!!!!!!!!!!!!!!
@Controller
public class QnaDownloadController implements ApplicationContextAware {
	...
	@RequestMapping("qnaphotoDownload/{filekey}")//file이름을 받아와서 다운로드 학기위함
	public ModelAndView download(
		...
		String fileName=qnaServiceImpl.qnaFileNameSearch(Integer.parseInt(filekey));
