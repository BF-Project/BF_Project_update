...
//xml에 쿼리 기입추가!!!!!!!!!!!!!!
@Controller
public class CmmtDownloadController implements ApplicationContextAware {
	...
	@RequestMapping("cmmtphotoDownload/{filekey}")//file이름을 받아와서 다운로드 학기위함
	public ModelAndView download(
		...
		String fileName=cmmtServiceImpl.cmmtFileNameSearch(Integer.parseInt(filekey));
