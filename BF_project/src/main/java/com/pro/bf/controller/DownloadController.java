...
public class DownloadController implements ApplicationContextAware{
	...
	@RequestMapping("photoDownLoad/{filekey}") // file이름을 받아와서 다운로드하기 위함
	public ModelAndView download(@PathVariable String filekey, HttpServletResponse response, HttpServletRequest request) throws IOException, NumberFormatException, SQLException{
...
//		String fileSite = context.getServletContext().getRealPath("resources/upload");
